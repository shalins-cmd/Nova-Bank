...
function App() {
  ...
  const handleLoginSubmit = (e: React.FormEvent) => {
    ...
    if (loginStep === 1) {
      setLoginStep(2);
      // GTM track step 1
      pushEvent('login_step_complete', { step: 1, method: 'user_id' });
    } else {
      setIsLoginModalOpen(false);
      setLoginStep(1);
      setIsLoggedIn(true);
      // GTM track login success
      pushEvent('login_success', { user_id_hash: btoa(userId) });
    }
  };
      ...
      <div className="flex flex-col min-h-screen font-sans text-gray-900">
        <Navbar 
          ...
          onLoginClick={() => {
            ...
            pushEvent('login_modal_open', { source: 'navbar' });
          }} 
        />
